...
const columnDefs = [
    ...
    { field: 'WkDeptName', headerName: 'Bộ phận làm việc', sortable: true, filter: true },
    ...
    { field: 'OrdDate', headerName: 'Ngày bổ nhiệm', sortable: true, filter: true },
    { field: 'SMSexName', headerName: 'Giới tính', sortable: true, filter: true },
];

export default function CodeHelpAddUsers({ setConditionSeq, conditionSeq, data, modalVisible, setModalVisible, setKeyword, keyword, loadingCodeHelp, handleSearch, onRowClickedCodeHelp, setSubConditionSql, subConditionSql }) {
    ...
    return (
        <div>
            <Modal
                ...
                closable={false}
            >
                <div className="ag-theme-quartz cursor-pointer" style={{ display: 'flex', flexDirection: 'column', height: '75vh' }}>
                    <div className="flex p-2 bg-white border mb-2 rounded-lg gap-4">
                        ...
                        <div className="flex flex-col">
                            <Select
                                ...
                                options={[
                                    { value: '', label: 'All' },
                                    { value: 'TypeSeq = 3031001', label: 'Người đương chức, đương nhiệm' },
                                    { value: 'TypeSeq = 3031002', label: 'Người thôi việc, nghỉ làm' },
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <Search
                                allowClear
                                size="middle" placeholder="Tìm kiếm" value={keyword} onKeyDown={(e) => {
                                    if (e.key === 'Enter') {
                                        handleSearch();
                                    }
                                }}
                        ...
                        <div className="flex flex-col">
                            <Button type="primary" icon={<SearchOutlined />} size="middle" onClick={handleSearch}
