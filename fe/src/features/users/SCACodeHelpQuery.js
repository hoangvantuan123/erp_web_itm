...
export const SCACodeHelpQuery = (keyword, conditionSeq, subConditionSql) => {
    ...
    const dataToSend = {
        ...
        keyword: `%${requestParams.keyword}%`, // Xử lý keyword với ký tự %
        param1: requestParams.param1,
        param2: requestParams.param2,
        param3: requestParams.param3,
        param4: requestParams.param4,
        conditionSeq: `${requestParams.conditionSeq}`, // Xử lý conditionSeq
        pageCount: requestParams.pageCount,
        pageSize: requestParams.pageSize,
        subConditionSql: `${requestParams.subConditionSql}`, // Xử lý subConditionSql
    ...
    return axios.post(`${HOST_API_SERVER_1}/mssql/users/SCACodeHelpQuery`, dataToSend, {
        headers: {
    ...
    .then(response => {
        ...
        throw new Error('Error from API: ' + (response.data.message || 'Unknown error'));
    })
    .catch(error => {
